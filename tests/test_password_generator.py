...
def test_passwords_are_different_between_sessions():
    password1 = generate_password(12)
    # Simule la fermeture et la réouverture de l'app en générant à nouveau dans un nouvel appel de fonction
    password2 = generate_password(12)
    assert password1 != password2
...
def test_unique_passwords_in_a_session():
    ...
    for _ in range(1000):
        ...
        assert password not in generated_passwords # Il ne doit pas y avoir de répétition
